...
/// Lifetime-aware accessor marker for the table `user`.
pub struct UserTableAccessor;

impl __sdk::TableAccessor<super::RemoteTables> for UserTableAccessor {
    type Row = User;
    type Handle<'db> = UserTableHandle<'db>;
